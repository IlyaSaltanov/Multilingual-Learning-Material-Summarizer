...
### 🌍 Multilingual Learning Material Summarizer - Установка на Windows

## 📋 Предварительные требования

1. **Скачайте Python 3.11.0** с официального сайта:
   - Перейдите на [python.org/downloads/release/python-3110/](https://www.python.org/downloads/release/python-3110/)
   - Выберите **Windows installer (64-bit)** (если у вас 64-битная система)
   - **Важно**: Скачивайте именно версию **3.11.0**, не последнюю версию!

2. **Установите Python 3.11.0**:
